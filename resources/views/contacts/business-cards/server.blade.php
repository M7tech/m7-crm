<x-layouts::app :title="__('Scan business card')">
    <div class="mx-auto flex w-full max-w-5xl flex-1 flex-col gap-6 p-4 sm:p-6 lg:p-8">
        <div>
            ...
            <h1 class="mt-3 text-2xl font-semibold tracking-tight text-zinc-950 dark:text-white">Scan on the server</h1>
            <a href="{{ route('contacts.business-cards.create') }}" class="text-emerald-700 underline" wire:navigate>Return to private on-device scanning</a>
